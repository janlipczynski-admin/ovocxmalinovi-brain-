...
Wynik jest dostępny bezpośrednio w wierszu "WIG Status" (kolumna B) arkusza OS_LAG MEASURES.
...
| LAG-02 | Obsługa zamówień (optymalizacja) | 6 kryteriów |
| LAG-03 | Rozliczenia tygodniowe | 6 kryteriów |
| LAG-04 | Reklamacje | 6 kryteriów |
...
(Jest to ŚREDNIA postępów LAG-01..LAG-05, liczona formułą w arkuszu)
```
